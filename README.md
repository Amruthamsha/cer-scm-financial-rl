...
> Optimised for RTX 3090 (24 GB VRAM): AMP mixed precision, `cudnn.benchmark`, `torch.compile`, robust checkpointing, and a full 7-method experiment loop across 24 assets.
...
- The main experiment loop covers **24 assets × 10 trials** across US Tech, US Finance, and Asian markets (4 markets) — this is compute-intensive; a modern GPU is strongly recommended.
